...
public class SettingsActivity extends Activity {
    ...
    private EditText edtServer, edtPerPage;
    private Spinner spnLang;
    private Button btnSave;
    private CheckBox chkAutoInstallRoot, chkDarkTheme;
    ...
    protected void onCreate(Bundle b) {
        ...
        edtPerPage.setText(String.valueOf(Prefs.getPerPage(this)));
        ...
        if (chkDarkTheme != null) {
            chkDarkTheme.setChecked(Prefs.isDarkTheme(this));
        }
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                int pp = 15;
                try { pp = Integer.parseInt(edtPerPage.getText().toString().trim()); } catch (Exception e) { }
                Prefs.setPerPage(SettingsActivity.this, pp);

                boolean dark = chkDarkTheme != null && chkDarkTheme.isChecked();
                Prefs.setDarkTheme(SettingsActivity.this, dark);
